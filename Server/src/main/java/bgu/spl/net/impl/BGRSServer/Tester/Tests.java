...
public class Tests implements Runnable {
    ...
    public String testRegisLoginLogoutMultipleDifferentUser() {
        ...
        try {
            ...
            if (numTimesSuccess == numThreads * 3) {
                ...
                System.out.println(numTimesSuccess);
                System.out.println(numThreads*3);
                System.out.println("ack 2: "+ack2);
                System.out.println("ack 3: "+ack3);
                System.out.println("ack 4: "+ack4);
    ...
    public void run() {
        try {
            ...
            new Thread(() -> {
                TPCMain.main(new String[]{"7777",Integer.toString(20)}); //You can change it to reactor also
            }).start();
